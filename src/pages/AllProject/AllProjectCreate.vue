    ...
    <el-container>
      <el-main>
        <div class="box" title="项目基本信息">
          ...
          <el-button style="margin: 0px 0px 20px 60px;background-color: rgb(102, 153, 204);color: white" @click="CreateProject">提 交</el-button>
        </div>
...
<script>
  import AllPeriodsBar from '../../components/PeriodsBar/PeriodsBar'
    ...
    methods: {
      ...
      CreateProject(){
        return new Promise((resolve, reject) => {
          ...
          this.$api.allProject.CreateProject({contactName, contactTel, customerId, name, leaderId, reserveLeaderIds, type}).then(res =>{
            if(res.data.code == 200){
              this.$message({
                message: '新增项目成功!',
                type: 'success'
